  ...
  return (
    <div>
      ...
      <div className='flex gap-4'>
        ...
        <div className='flex flex-col gap-1 p-5 bg-slate-200 rounded-lg shadow-md'>
          <h2 className='text-2xl font-bold'>File Leave</h2>
          <FileLeave employeeId={employee?.employeeId?.toString()} id={Number(employee?.id)}/>
        </div>
      </div>
