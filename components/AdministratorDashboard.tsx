      ...
      <div className="flex flex-col gap-1 p-5 bg-slate-200 rounded-lg shadow-md h-full">
        ...
        {employee && (
          <>
            ...
            <h2>
              <span className="font-bold">Name:</span> {employee.lastName},{" "}
            ...
            <h2>
              <span className="font-bold">Address:</span> {employee.zipCode}{" "}
              {employee.streetAddress}, {employee.barangay}, {employee.city},{" "}
